...
const (
	UserService_CheckUserExists_FullMethodName = "/main.UserService/CheckUserExists"
)
...
type UserServiceClient interface {
	CheckUserExists(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error)
}
...
func (c *userServiceClient) CheckUserExists(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
...
type UserServiceServer interface {
	CheckUserExists(context.Context, *UserRequest) (*UserResponse, error)
...
func (UnimplementedUserServiceServer) CheckUserExists(context.Context, *UserRequest) (*UserResponse, error) {
...
func _UserService_CheckUserExists_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).CheckUserExists(ctx, req.(*UserRequest))
	}
